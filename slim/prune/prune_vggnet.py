...
from .misc import set_module_list, computer_bn_threshold, round_to_multiple_of
from .layers import create_linear, create_conv2d, create_dropout, create_batchnorm2d


def prune_conv_bn_relu(old_conv2d, old_batchnorm2d, old_relu, bn_threshold,
    ...
    return new_conv2d, new_batchnorm2d, new_relu, out_channels, out_idx


def prune_features(module_list, bn_threshold, minimum_channels=8, divisor=8):
    """
    We already know the structure of features module, collect BN layers one by one, calculate the number of pruning, and rebuild
    """
